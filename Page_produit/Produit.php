    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top" margin><img src="img/LMS__1_-removebg-preview.png" height="100" width="100"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#projects">A propos de</a></li>
                        <li class="nav-item"><a class="nav-link" href="#projects">Nos produit</a></li>
